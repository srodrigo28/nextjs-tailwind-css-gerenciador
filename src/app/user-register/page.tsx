    ...
    return(
        <main>
          <div className="flex pb-60 items-center justify-center h-screen  bg-gray-700">
              <form className="container items-center flex flex-col space-y-6 p-8 max-w-md rounded-xl bg-gray-300 shadow-xl">

              <div className="flex items-center gap-2 max-w-md">
                <span className='text-emerald-500 text-3xl font-bold'>Logo</span>
                <h1 className='uppercase text-slate-700 font-bold text-xl'>Cadastra-se</h1>
              </div>

              <input type='text' placeholder='Seu nome' className=" w-full p-3 font-bold text-md rounded-md"  />

              <input type='text' placeholder='Seu cpf' className=" w-full p-3 font-bold text-md rounded-md" />
